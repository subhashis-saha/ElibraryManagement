                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <center>
                                    <img src="Image/generaluser.png" width="100" />
                                </center>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col md-6">
                                ...
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="Txtcont" runat="server" placeholder="Contuct Number" TextMode="Number"></asp:TextBox>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col md-4">
                                <label>Pincode</label>
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="Txtpinco" runat="server" placeholder="Pincode" TextMode="Number"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="Txtfaddre" runat="server" placeholder="Full Address" TextMode="MultiLine" Rows="2"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <br />
                        ...
                        <div class="row">
                            <div class="col md-6">
                                <label>User ID</label>
                                <div class="form-group">
                                    <asp:TextBox Class="form-control" ID="Txtusid" runat="server" placeholder="User ID"></asp:TextBox>
                                </div>
                            </div>
